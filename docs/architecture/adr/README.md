...
| [0005](file:///e:/projects/gsolut/mvp-crypto-multi-tool/docs/adr/0005-web-client-spa-and-charts.md) | Web Cockpit en Tiempo Real y Gráficos Livianos | Aceptado | 2026-09-23 | Construcción de una SPA en tiempo real con WebSocket/SSE y gráficos financieros para inspección de setups. |
| [0006](file:///e:/projects/gsolut/mvp-crypto-multi-tool/docs/adr/0006-hybrid-multimodal-agent-mcp.md) | Protocolo MCP y Auditoría Multimodal Agéntica | Aceptado | 2026-09-23 | Interfaz MCP en 5 pasos donde el agente audita conjuntamente números calculados e imágenes renderizadas de calor. |
