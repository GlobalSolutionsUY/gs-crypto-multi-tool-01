...
## 4. Contratos de Datos para Frontend (TypeScript Interfaces)

Para el cliente Web Cockpit y consumidores de la API REST/SSE, las definiciones canónicas en TypeScript correspondientes son:

```typescript
export type OpportunityStatus = "DISCOVERY" | "WATCH" | "READY" | "TRIGGERED" | "INVALIDATED" | "EXPIRED";
